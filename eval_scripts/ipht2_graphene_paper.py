...
options = {
# filter paper
"cbar_lim": (1.2, 1.7), # filter paper uncoated p2p img0
...
"eval_opt": {"shift_sub": 0, # ref <-> sam pulse shift in fs
             "shift_film": 0,
             "sub_pnt": (41, 0),#(32, 5),
             "fit_range_film": (0.35, 2.0),#(0.5, 2.0)
             "fit_range_sub": (0.1, 3.0), # (0.10, 3.0)
             "nfp": 0, # number of fp pulses contained in window ("inf" or 0, 1, ..., N),
             "area_fit": False,
             "sub_bounds": [(1.27, 1.37), (0.000, 0.1)],
             "film_bounds": [(1, 15), (0, 15)],
             "freq_model_bounds": [(1e2, 1e4), (1e3, 1e4), (0, 30), (1e2, 1e3), (-2e5, 2e3)],
             # "freq_model_bounds": [(1, 10), (1e1, 1e4), (0.1, 20), (-1, 1)]
             "freq_model_bounds": [(1e-2, 50), (1e-2, 1e1), (1e-4, 1e1), (-1, 1)],
